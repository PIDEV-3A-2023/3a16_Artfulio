...
exports.LookupTestFixture = void 0;
var nominatim_browser_1 = require("../nominatim-browser");
var alsatian_1 = require("alsatian");
var LookupTestFixture = /** @class */ (function () {
    function LookupTestFixture() {
    }
    LookupTestFixture.prototype.lookup = function () {
        return __awaiter(this, void 0, void 0, function () {
            var results, result, address;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, nominatim_browser_1.lookupAddress({
    ...
    __decorate([
        alsatian_1.AsyncTest(".lookup(): Should return data for osm addresses"),
        alsatian_1.Timeout(5000)
    ], LookupTestFixture.prototype, "lookup", null);
    LookupTestFixture = __decorate([
        alsatian_1.TestFixture(".lookup test fixture")
    ], LookupTestFixture);
    return LookupTestFixture;
}());
exports.LookupTestFixture = LookupTestFixture;

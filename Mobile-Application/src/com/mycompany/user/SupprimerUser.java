 ...
 * @author user
 */
public class SupprimerUser extends BaseForm{
     public SupprimerUser(Resources res) {
        super(new BorderLayout());
        setTitle("Supprimer user");
         ...
         for (Utilisateur t : users) {
           ...
           Container content = BoxLayout.encloseY(
                ...
                roles
                   ...
                   Button next = new Button("Supprimer");
            ...
            public void actionPerformed(ActionEvent evt) {
               ...
               
                {
                    try {
                        ...
                        if( ServiceUtlisateur.getInstance().SupprimerUser(id))
                        {
                           InfiniteProgress ip = new InfiniteProgress();
                                final Dialog ipDialog =  ip.showInfiniteBlocking();
                            
                                ipDialog.dispose();
            Dialog.show("Success","Utilisateur supprimer",new Command("OK"));

 ...
 * @author MSI
 */
public class MenuStore extends Form{
    Form current;
private Resources theme;


    public MenuStore(Form prev){
   current = this;
    setTitle("Gestion des Store");
    ...
    Button b1 = new Button("Ajouter Store");
    Button b2 = new Button("List des Store");

    b1.addActionListener(l -> new getStoreForm().show());
    b2.addActionListener(l -> new getStoreForm().show());

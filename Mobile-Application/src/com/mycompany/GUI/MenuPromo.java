 ...
 * @author Andrew
 */
public class MenuPromo extends Form {
     Form current;
private Resources theme;


    public MenuPromo(Form prev){
   current = this;
    ...
    Button b1 = new Button("Ajouter Promotion");
    Button b2 = new Button("List des Promotions");

    b1.addActionListener(l -> new newPromotionForm().show());
    b2.addActionListener(l -> new getPromotionForm().show());

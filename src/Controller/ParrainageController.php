...
class ParrainageController extends AbstractController
{
    ...
    public function admin(Request $request, PaginatorInterface $paginator): Response
   {
    ...
    switch ($sortBy) {
        ...
        default:
            $queryBuilder->orderBy('p.idParrainage', 'ASC');
            break;
     }
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        $user = $parrainage->getUser(); // Get the user who made the request
        $userEmail = $user->getEmailUser(); // Get the user's email address

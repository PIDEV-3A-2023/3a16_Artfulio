 ...
 * @author user
 */
public class Profile_User extends BaseForm {

    public Profile_User(Resources res) {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((username.getText().length() == 0)) {
                    ...
                    try {
                        ...
                        if (ServiceUtlisateur.getInstance().ModifierUser(userr.getId(), user)) {
                            InfiniteProgress ip = new InfiniteProgress();
                            final Dialog ipDialog = ip.showInfiniteBlocking();
                            Storage.getInstance().deleteStorageFile("Utilisateur");

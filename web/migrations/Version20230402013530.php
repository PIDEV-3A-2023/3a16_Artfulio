 ...
 */
final class Version20230402013530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork DROP id_type, CHANGE id_artist id_artist INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork ADD id_type INT NOT NULL, CHANGE id_artist id_artist INT NOT NULL');

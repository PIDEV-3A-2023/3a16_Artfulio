 ...
 */
final class Version20230410162257 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork MODIFY id_artwork INT NOT NULL');
        ...
        $this->addSql('DROP INDEX `primary` ON artwork');
        $this->addSql('ALTER TABLE artwork CHANGE id_type_id id_type_id INT DEFAULT NULL, CHANGE id_artwork id INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('ALTER TABLE artwork ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67DF7384557 FOREIGN KEY (id_produit) REFERENCES artwork (id)');
        ...
        $this->addSql('ALTER TABLE commentaire ADD id_artwork_id INT DEFAULT NULL, DROP id_util, DROP id_artwork, CHANGE Texte texte VARCHAR(255) NOT NULL, CHANGE Date_post date_post DATETIME NOT NULL');
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BCA8327F73 FOREIGN KEY (id_artwork_id) REFERENCES artwork (id)');
        $this->addSql('CREATE INDEX IDX_67F068BCA8327F73 ON commentaire (id_artwork_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork MODIFY id INT NOT NULL');
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON artwork');
        $this->addSql('ALTER TABLE artwork CHANGE id_type_id id_type_id INT NOT NULL, CHANGE id id_artwork INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('ALTER TABLE artwork ADD PRIMARY KEY (id_artwork)');
        ...
        $this->addSql('ALTER TABLE commentaire DROP FOREIGN KEY FK_67F068BCA8327F73');
        $this->addSql('DROP INDEX IDX_67F068BCA8327F73 ON commentaire');
        $this->addSql('ALTER TABLE commentaire ADD id_util INT NOT NULL, ADD id_artwork INT NOT NULL, DROP id_artwork_id, CHANGE texte Texte VARCHAR(200) NOT NULL, CHANGE date_post Date_post DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');

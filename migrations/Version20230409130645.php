 ...
 */
final class Version20230409130645 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork ADD id_artist_id INT NOT NULL, ADD id_type_id INT DEFAULT NULL, DROP id_type, DROP id_artist');
        ...
        $this->addSql('CREATE INDEX IDX_881FC57637A2B0DF ON artwork (id_artist_id)');
        $this->addSql('CREATE INDEX IDX_881FC5761BD125E3 ON artwork (id_type_id)');
        ...
        $this->addSql('ALTER TABLE sous_cat DROP nom_sous_cat, CHANGE id_sous_cat id INT AUTO_INCREMENT NOT NULL');
        $this->addSql('ALTER TABLE sous_cat ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE user DROP type_role, CHANGE username username VARCHAR(255) NOT NULL, CHANGE cin_user cin_user VARCHAR(255) NOT NULL, CHANGE adresse_user adresse_user VARCHAR(255) NOT NULL, CHANGE password_user password_user VARCHAR(255) NOT NULL, CHANGE email_user email_user VARCHAR(255) NOT NULL, CHANGE is_pro is_pro TINYINT(1) NOT NULL, CHANGE img_user img_user VARCHAR(255) NOT NULL, CHANGE id_user id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON user');
        $this->addSql('ALTER TABLE user ADD type_role VARCHAR(20) NOT NULL, CHANGE username username VARCHAR(50) NOT NULL, CHANGE cin_user cin_user VARCHAR(8) NOT NULL, CHANGE adresse_user adresse_user VARCHAR(50) NOT NULL, CHANGE password_user password_user VARCHAR(50) NOT NULL, CHANGE email_user email_user VARCHAR(50) NOT NULL, CHANGE is_pro is_pro TINYINT(1) DEFAULT 0 NOT NULL, CHANGE img_user img_user VARCHAR(255) DEFAULT NULL, CHANGE id id_user INT AUTO_INCREMENT NOT NULL');
        ...
        $this->addSql('DROP INDEX IDX_881FC57637A2B0DF ON artwork');
        $this->addSql('DROP INDEX IDX_881FC5761BD125E3 ON artwork');
        $this->addSql('ALTER TABLE artwork ADD id_artist INT NOT NULL, DROP id_type_id, CHANGE id_artist_id id_type INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE sous_cat MODIFY id INT NOT NULL');
        $this->addSql('DROP INDEX `PRIMARY` ON sous_cat');
        $this->addSql('ALTER TABLE sous_cat ADD nom_sous_cat VARCHAR(255) NOT NULL, CHANGE id id_sous_cat INT AUTO_INCREMENT NOT NULL');

 ...
 */
final class Version20230328172128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork ADD idArtist INT DEFAULT NULL, ADD idType INT DEFAULT NULL, DROP id_type, DROP id_artist');
        $this->addSql('ALTER TABLE artwork ADD CONSTRAINT FK_881FC57662483E1D FOREIGN KEY (idArtist) REFERENCES user (idUser)');
        $this->addSql('ALTER TABLE artwork ADD CONSTRAINT FK_881FC576FF2309B7 FOREIGN KEY (idType) REFERENCES sous_cat (idSousCat)');
        $this->addSql('CREATE INDEX IDX_881FC57662483E1D ON artwork (idArtist)');
        $this->addSql('CREATE INDEX IDX_881FC576FF2309B7 ON artwork (idType)');
        ...
        $this->addSql('ALTER TABLE user ADD typeRole VARCHAR(255) DEFAULT NULL, DROP type_role, CHANGE username username VARCHAR(255) NOT NULL, CHANGE cin_user cin_user VARCHAR(255) NOT NULL, CHANGE adresse_user adresse_user VARCHAR(255) NOT NULL, CHANGE password_user password_user VARCHAR(255) NOT NULL, CHANGE email_user email_user VARCHAR(255) NOT NULL, CHANGE is_pro is_pro TINYINT(1) NOT NULL, CHANGE img_user img_user VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork DROP FOREIGN KEY FK_881FC57662483E1D');
        $this->addSql('ALTER TABLE artwork DROP FOREIGN KEY FK_881FC576FF2309B7');
        $this->addSql('DROP INDEX IDX_881FC57662483E1D ON artwork');
        $this->addSql('DROP INDEX IDX_881FC576FF2309B7 ON artwork');
        $this->addSql('ALTER TABLE artwork ADD id_type INT NOT NULL, ADD id_artist INT NOT NULL, DROP idArtist, DROP idType');
        ...
        $this->addSql('ALTER TABLE user ADD type_role VARCHAR(20) NOT NULL, DROP typeRole, CHANGE username username VARCHAR(50) NOT NULL, CHANGE cin_user cin_user VARCHAR(8) NOT NULL, CHANGE adresse_user adresse_user VARCHAR(50) NOT NULL, CHANGE password_user password_user VARCHAR(50) NOT NULL, CHANGE email_user email_user VARCHAR(50) NOT NULL, CHANGE is_pro is_pro TINYINT(1) DEFAULT 0 NOT NULL, CHANGE img_user img_user VARCHAR(255) DEFAULT NULL');

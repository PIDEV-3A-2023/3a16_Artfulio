 ...
 */
final class Version20230408185015 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE role CHANGE type_role type_role VARCHAR(255) NOT NULL, CHANGE id_role id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON role');
        $this->addSql('ALTER TABLE role CHANGE type_role type_role VARCHAR(20) NOT NULL, CHANGE id id_role INT AUTO_INCREMENT NOT NULL');

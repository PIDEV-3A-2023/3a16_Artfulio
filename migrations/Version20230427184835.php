 ...
 */
final class Version20230427184835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP INDEX email_user, ADD UNIQUE INDEX UNIQ_8D93D64912A5F6CC (email_user)');
        $this->addSql('DROP INDEX role ON user');
        $this->addSql('DROP INDEX is_pro ON user');
        $this->addSql('DROP INDEX username ON user');
        $this->addSql('ALTER TABLE user DROP username, DROP cin_user, DROP adresse_user, DROP type_role, DROP is_pro, DROP img_user, CHANGE password_user password_user VARCHAR(255) NOT NULL, CHANGE email_user email_user VARCHAR(180) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE artist (id INT NOT NULL, username VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, password VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, email VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, roles JSON NOT NULL) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE user DROP INDEX UNIQ_8D93D64912A5F6CC, ADD INDEX email_user (email_user)');
        $this->addSql('ALTER TABLE user ADD username VARCHAR(50) NOT NULL, ADD cin_user VARCHAR(8) NOT NULL, ADD adresse_user VARCHAR(50) NOT NULL, ADD type_role VARCHAR(20) NOT NULL, ADD is_pro TINYINT(1) DEFAULT 0 NOT NULL, ADD img_user VARCHAR(255) DEFAULT NULL, CHANGE email_user email_user VARCHAR(50) NOT NULL, CHANGE password_user password_user VARCHAR(50) DEFAULT NULL');

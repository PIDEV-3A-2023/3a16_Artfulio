 ...
 */
final class Version20230328184720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork CHANGE id_type id_type INT DEFAULT NULL, CHANGE id_artist id_artist INT DEFAULT NULL');
        $this->addSql('ALTER TABLE artwork RENAME INDEX fk_id_artist TO IDX_881FC576276E236A');
        $this->addSql('ALTER TABLE artwork RENAME INDEX fk_id_type TO IDX_881FC5767FE4B2B');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE artwork CHANGE id_artist id_artist INT NOT NULL, CHANGE id_type id_type INT NOT NULL');
        $this->addSql('ALTER TABLE artwork RENAME INDEX idx_881fc5767fe4b2b TO fk_id_type');

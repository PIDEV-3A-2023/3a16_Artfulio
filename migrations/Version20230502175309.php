 ...
 */
final class Version20230502175309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE promotion DROP nom_artwork, DROP prix_artwork, CHANGE id_artwork id_artwork INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE promotion ADD nom_artwork VARCHAR(255) NOT NULL, ADD prix_artwork INT NOT NULL, CHANGE id_artwork id_artwork INT NOT NULL');

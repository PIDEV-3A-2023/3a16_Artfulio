 ...
 */
final class Version20230428080130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP username, DROP cin_user, DROP adresse_user, DROP type_role, DROP is_pro, DROP img_user, CHANGE password password VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(180) NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, password VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, email VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_0900_ai_ci`, roles JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE user ADD username VARCHAR(50) NOT NULL, ADD cin_user VARCHAR(8) NOT NULL, ADD adresse_user VARCHAR(50) NOT NULL, ADD type_role VARCHAR(20) NOT NULL, ADD is_pro TINYINT(1) DEFAULT 0 NOT NULL, ADD img_user VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(250) NOT NULL, CHANGE password password VARCHAR(50) DEFAULT NULL');
